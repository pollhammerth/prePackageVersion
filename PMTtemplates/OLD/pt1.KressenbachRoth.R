...
setwd("H:/GIS/PhD/profiles/IllerLechPlatte/KressenbachRoth") # Win
...
search.radius <- 5000 # 6500 in FLAGG 1
# spatial resolution in [m]
analysis.resolution <- 30
...
dem_1.path.name.extension <- c("H:/GIS/DEMs/5m", 
                               "naf_5m_EPSG32632___", 
                               ".tif")
